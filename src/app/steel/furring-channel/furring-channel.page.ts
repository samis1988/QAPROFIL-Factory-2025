...
@Component({
  selector: 'app-furring-channel',
  templateUrl: './furring-channel.page.html',
  styleUrls: ['./furring-channel.page.scss'],
})
export class FurringChannelPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/furring_channel.png";
  ngOnInit() {
  ...
  addtocart(inputRef: IonInput) {
    const item_name = "Furring Channel";
    const color = "Galv";
    const l_m = "3";
