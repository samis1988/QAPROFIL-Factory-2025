...
@Component({
  selector: 'app-anglebead',
  templateUrl: './anglebead.page.html',
  styleUrls: ['./anglebead.page.scss'],
})
export class AnglebeadPage implements OnInit {
  selectedSize: string = '';
  ...
  image1: any = "assets/img/qaprofil/angle.png";
  ngOnInit() {
  }
