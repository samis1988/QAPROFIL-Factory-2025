...
@Component({
  selector: 'app-mainchannel',
  templateUrl: './mainchannel.page.html',
  styleUrls: ['./mainchannel.page.scss'],
})
export class MainchannelPage implements OnInit {
  selectedSize: string = '';
  ...
  image1: any = "assets/img/qaprofil/main.png";
  ngOnInit() {
  }
