...
@Component({
  selector: 'app-studles',
  templateUrl: './studles.page.html',
  styleUrls: ['./studles.page.scss'],
})
export class StudlesPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/stud_les.png";
  ngOnInit() {
  }
