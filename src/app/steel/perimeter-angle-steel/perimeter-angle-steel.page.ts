...
@Component({
  selector: 'app-perimeter-angle-steel',
  templateUrl: './perimeter-angle-steel.page.html',
  styleUrls: ['./perimeter-angle-steel.page.scss'],
})
export class PerimeterAngleSteelPage implements OnInit {
  cartItems: any[] = [];
  ...
  image1: any = "../../assets/img/qaprofil/perimeterangle.png";
  ngOnInit() {
  ...
  addtocart(inputRef: IonInput) {
    const item_name = "Perimeter Angle";
    const color = "Galv";
    const l_m = "3";
