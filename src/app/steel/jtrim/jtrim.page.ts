...
@Component({
  selector: 'app-jtrim',
  templateUrl: './jtrim.page.html',
  styleUrls: ['./jtrim.page.scss'],
})
export class JtrimPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/jtrim.png";
  ngOnInit() {
  }
