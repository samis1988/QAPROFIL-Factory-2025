...
@Component({
  ...
  templateUrl: './order-list-admin.page.html',
  styleUrls: ['./order-list-admin.page.scss'],
})
export class OrderListAdminPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.authService.getProfile().then(user => {
      ...
      this.dataService.getMsgOrderAdmin(this.userId).subscribe(data => {
