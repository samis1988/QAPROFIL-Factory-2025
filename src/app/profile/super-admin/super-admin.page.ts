...
export class SuperAdminPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.authService.getProfile().then(user => {
      ...
      ///////////////////////////////////////////////////////////////
      this.dataService.getUserRead(this.userId).subscribe(data => {

        this.msg_support = data;
        this.total_user_new = this.msg_support.length;
      });

      ///////////////////////////////////////////////////////////////////////////
      ///////////////////////////////////////////////////////////////
      this.dataService.getRequestRead(this.userId).subscribe(data => {

        this.msg_support = data;
        this.total_msg_request_unread = this.msg_support.length;
      });
  ...
  user_read(email: string) {

    this.dataService.getUserReadUpate(email).subscribe(data => {
      this.router.navigateByUrl('/user-list');
    });

  }

  msg_request_read(email: string) {

    this.dataService.getRequestReadUpate(email).subscribe(data => {
      this.router.navigateByUrl('/request-list-admin');
    });
