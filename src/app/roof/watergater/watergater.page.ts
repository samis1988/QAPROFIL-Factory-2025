...
@Component({
  selector: 'app-watergater',
  templateUrl: './watergater.page.html',
  styleUrls: ['./watergater.page.scss'],
})
export class WatergaterPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/roof_pannel/water_gutter.bmp";
  ngOnInit() {
  }
