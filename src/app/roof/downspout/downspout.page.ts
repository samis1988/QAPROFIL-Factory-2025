...
@Component({
  selector: 'app-downspout',
  templateUrl: './downspout.page.html',
  styleUrls: ['./downspout.page.scss'],
})
export class DownspoutPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/roof_pannel/downspot1.png";
  image2: any = "assets/img/qaprofil/roof_pannel/downspot2.png";
  ngOnInit() {
  }
  ...
  async addtocart(inputRef: IonInput) {
    ...
    const item_name = "Down Spout";


    this.cartService.addItem(item_name, inputRef, this.selected_Thickness, this.image1, this.selectedColor, lm);
