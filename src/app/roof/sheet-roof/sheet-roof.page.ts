...
@Component({
  selector: 'app-sheet-roof',
  templateUrl: './sheet-roof.page.html',
  styleUrls: ['./sheet-roof.page.scss'],
})
export class SheetRoofPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/roof_pannel/roof-sheet.png";
  ngOnInit() {
  }
