...
@Component({
  selector: 'app-waveroof',
  templateUrl: './waveroof.page.html',
  styleUrls: ['./waveroof.page.scss'],
})
export class WaveroofPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/roof_pannel/wave.png";
  ngOnInit() {
  }
  ...
  async addtocart(inputRef: IonInput) {
    ...
    const item_name = "Wave Roof Tile Sheet";
