...
@Component({
  selector: 'app-arcroof',
  templateUrl: './arcroof.page.html',
  styleUrls: ['./arcroof.page.scss'],
})
export class ArcroofPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/roof_pannel/arc_roof.png";
  ngOnInit() {
  }
  ...
  async addtocart(inputRef: IonInput) {
    ...
    const item_name = "Arc Roof Tile Sheet";
