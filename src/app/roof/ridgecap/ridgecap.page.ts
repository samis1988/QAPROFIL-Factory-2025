...
@Component({
  selector: 'app-ridgecap',
  templateUrl: './ridgecap.page.html',
  styleUrls: ['./ridgecap.page.scss'],
})
export class RidgecapPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/roof_pannel/ridge_cap.png";
  ngOnInit() {
  }
