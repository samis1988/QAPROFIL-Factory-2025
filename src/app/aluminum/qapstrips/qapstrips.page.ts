...
@Component({
  selector: 'app-qapstrips',
  templateUrl: './qapstrips.page.html',
  styleUrls: ['./qapstrips.page.scss'],
})
export class QapstripsPage implements OnInit {
  @ViewChild('swiper')
  ...
  products: any[] = [
    { title: 'Gypsum Ceilings', component: 'gypsum', image: 'assets/img/qaprofil/qap50/1.png' },
    { title: 'Indoor Aluminum', component: 'aluminium', image: 'assets/img/qaprofil/qap50/2.png' },
    { title: 'Portacabin', component: 'LightgaugesteelPage', image: 'assets/img/qaprofil/full_image/qap50-1.jpg' },
  ...
  image1: any = "assets/img/qaprofil/qap50/1.png";
  ngOnInit() {
  }
