...
@Component({
  selector: 'app-qapcarrier',
  templateUrl: './qapcarrier.page.html',
  styleUrls: ['./qapcarrier.page.scss'],
})
export class QapcarrierPage implements OnInit {
  ...
  image1: any = "assets/img/qaprofil/qap_carrier.png";
  ngOnInit() {
  }
