...
@Component({
  selector: 'app-perimeteranglealum',
  templateUrl: './perimeteranglealum.page.html',
  styleUrls: ['./perimeteranglealum.page.scss'],
})
export class PerimeteranglealumPage implements OnInit {
  selectedSize: string = '';
  ...
  addtocart(inputRef: IonInput) {
    const item_name = "Prepainted Perimeter Angle";
    const color = "Matt White";
    const l_m = "3.6";
