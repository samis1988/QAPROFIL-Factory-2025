...
@Component({
  selector: 'app-vsection',
  templateUrl: './vsection.page.html',
  styleUrls: ['./vsection.page.scss'],
})
export class VsectionPage implements OnInit {
  ...
  image1: any = "../../assets/img/qaprofil/vsection.png";
  ngOnInit() {
  }
